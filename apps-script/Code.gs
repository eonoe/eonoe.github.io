...
var CONFIRMATION = {
  en: {
    ...
    subject: "You're in — Coding Agents 101 starts Mon, Sep 28",
    body: [
      "You're signed up for Coding Agents 101. Nothing else to do for now.",
      '',
      'Four live sessions, two hours each, 6:00 PM:',
      '  Mon, Sep 28 — Get an agent doing real work',
      '  Tue, Sep 29 — Context that makes it click',
      '  Wed, Sep 30 — Review like you mean it',
      '  Thu, Oct 1 — Make it stick',
      '',
  ...
  es: {
    from: 'Coding Agents 101',
    subject: 'Ya estás dentro — Coding Agents 101 empieza el lun 28 de septiembre',
    body: [
      ...
      '  Lun 28 sep — Pon un agente a trabajar de verdad',
      '  Mar 29 sep — El contexto que lo cambia todo',
      '  Mié 30 sep — Revisar en serio',
      '  Jue 1 oct — Que se quede contigo',
      '',
